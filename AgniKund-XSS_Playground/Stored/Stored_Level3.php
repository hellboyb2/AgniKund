<?php
	...
	if (isset($_POST["comment"]) && !empty($_POST["comment"])){
		...
		$comment = preg_replace("/(S|s)(T|t)(R|r)(I|i)(N|n)(G|g)|(X|x)(S|s){2}/", 'NO', $comment);
		$sql = 'INSERT INTO comments2(comment) VALUES(:comment_text)';
	...
	if (isset($_POST["clear"]) && !empty($_POST["clear"])){
		if ($_POST["clear"] == "yes"){
			...
			$db->exec('Delete from comments2 where 1=1');
		}

	}

	// Get all the comments.
	$comments = $db->query('Select * from comments2');
