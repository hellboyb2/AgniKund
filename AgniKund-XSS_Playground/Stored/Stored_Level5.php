<?php
	...
	if (isset($_POST["comment"]) && !empty($_POST["comment"])){
		...
		$comment = preg_replace("/(S|s)(T|t)(R|r)(I|i)(N|n)(G|g)|(X|x)(S|s){2}|(&#x)|(&#)|((<)( )*(S|s)(C|c)(R|r)(I|i)(P|p)(T|t)( )*(>))/", '', $comment);
		$comment = preg_replace("/((<)( )*(S|s)(C|c)(R|r)(I|i)(P|p)(T|t)( )*(>))/", '', $comment);
		$sql = 'INSERT INTO comments3(comment) VALUES(:comment_text)';
	...
	if (isset($_POST["clear"]) && !empty($_POST["clear"])){
		if ($_POST["clear"] == "yes"){
			...
			$db->exec('Delete from comments3 where 1=1');
		}

	}

	// Get all the comments.
	$comments = $db->query('Select * from comments3');
			...
			<div class="container column">
				<section class="section">
					<article class="message">
						...
						<div class="subtitle message-header">Level 5</div>
